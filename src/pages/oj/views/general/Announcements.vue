  ...
  <Row type="flex" :gutter="18">
    ...
    <Col :span="5" v-if="!isContest" >
      ...
      <Panel shadow style="margin-top: 37px;padding-bottom: 5px;">
        ...
        <ul style="margin-left: 40px;margin-bottom: 20px;">
          <li style="padding: 5px 0px;"><a href="#" class="link-style" onclick="event.preventDefault();window.open('https://www.facebook.com/groups/xoamulaptrinh/?ref=learncode', '_blank');">Cộng đồng Xóa "Mù" Lập Trình</a></li>
          <li style="padding: 5px 0px;"><a href="#" class="link-style" onclick="event.preventDefault();window.open('https://www.facebook.com/xoamulaptrinh/', '_blank');">Xóa "Mù" Lập Trình fanpage</a></li>
        </ul>
      </Panel>
    </Col>
  </Row>
